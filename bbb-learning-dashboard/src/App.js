              ...
              <Card>
                <CardContent classes={{ root: '!p-0' }}>
                  <CardBody
                    ...
                    number={usersCount}
                    cardClass={tab === TABS.OVERVIEW ? 'card-restyle-user' : 'card-restyle-user-inactive'}
              ...
              <Card>
                <CardContent classes={{ root: '!p-0' }}>
                  <CardBody
                    ...
                    cardClass={tab === TABS.OVERVIEW_ACTIVITY_SCORE ? 'card-restyle-score' : 'card-restyle-score-inactive'}
              ...
              <Card>
                <CardContent classes={{ root: '!p-0' }}>
                  <CardBody
                    ...
                    cardClass={tab === TABS.TIMELINE ? 'card-restyle-time' : 'card-restyle-time-inactive'}
              ...
              <Card>
                <CardContent classes={{ root: '!p-0' }}>
                  <CardBody
                    ...
                    cardClass={tab === TABS.POLLING ? 'card-restyle-poll' : 'card-restyle-poll-inactive'}
